...
import { BecomeAPartnerAPiold, GetCatAPi } from '../../Slices/BecomeAPartner';
...
const BecomePartner = () => {
  ...
  const onSubmit = async (values) => {
    ...
    await dispatch(BecomeAPartnerAPiold(formData))
      .then((response) => {
        if (response.success) {
                  ...
                  <div className="login-page__wrap">
                    ...
                    <ul className="login-points">
                      ...
                      <li>
                        ...
                        <br />
                        <br />
                        All our trade partners MUST be one of our "Accumulating Members" or "Mentoring Members" from Broze to
                        Diamond, so their membership level corresponds to their partnership level, eg, a Broze member becomes a Broze
                        Partner, a Diamond Member becomes a Diamond Partner, so they can enjoy more benefits of extra fun, promotion,
                        networking, million dollars mentoring, or potentially win $100,000 cash. There is only a one-off set-up fee of $99
                        +GST for each of the partners to set up your logo and a brief introduction within the member's page. A genuine 5-30%
                        discount minimum off your advertised RRP rate MUST be offered to our members to help you generate more business or
                        branding awareness.
                        <br />
                        <br />
