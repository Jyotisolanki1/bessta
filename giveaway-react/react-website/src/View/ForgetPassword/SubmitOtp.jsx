...
const SubmitOtp = () => {
  ...
  const resendOtp = async () => {
    try {
      const forgetopt = localStorage.getItem('forgetOptCount');
      if (forgetopt >= 3) {
  ...
  useEffect(() => {
    localStorage.setItem('forgetOptCount', count);
  }, [count]);
  ...
  return (
    <div className="login-new-section" style={{ marginTop: '0px', height: '100vh' }}>
          ...
          <div className="col-lg-5 right-side">
            <div className="form-2-wrapper">
              <div className="logo text-center mb-4">
                ...
                <h3 className="text-center mb-4">Enter Otp - {otp}</h3>
              </div>
