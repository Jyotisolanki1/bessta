...
export function getMails() {
  return async () => {
    try {
      const response = await axios.get('https://mock-data-api-nextjs.vercel.app/api/mails/list');
...
export function filterMails(filter) {
  return async () => {
    try {
      const response = await axios.post('https://mock-data-api-nextjs.vercel.app/api/mails/filter', { filter });
...
export function setImportant(id) {
  return async () => {
    try {
      await axios.post('https://mock-data-api-nextjs.vercel.app/api/mails/setImportant', { id });
    } catch (error) {
      dispatch(slice.actions.hasError(error));
    }
  };
