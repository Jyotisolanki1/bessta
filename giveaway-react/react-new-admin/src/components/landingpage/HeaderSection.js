...
import RequestCompany from 'views/landing/RequestCompany';
          ...
          <Grid container spacing={5}>
            ...
            <Grid item xs={12} sx={{ mt: -2.5, textAlign: { xs: 'center', md: 'left' } }}>
              ...
              >
                ...
                >
                  A Powerful Tracking, Monitoring & Reporting System Along With Convenient Tools & Workflows to Accelerate Your Field
                  Operations.
                </Typography>
              </motion.div>
            </Grid>
                ...
                <Grid container spacing={2} sx={{ justifyContent: { xs: 'center', md: 'flex-start' } }}>
                  <Grid item>
                    <AnimateButton>
                      ...
                      {open && <RequestCompany open={open} close={() => setOpen(false)} />}
                    </AnimateButton>
                  </Grid>
                  {/* <Grid item>
