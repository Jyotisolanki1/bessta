              ...
              <Paper elevation={16}>
                {open && (
                  ...
                  >
                    ...
                    <ListItemButton selected={language === 'ge'} onClick={(event) => handleListItemClick(event, 'ge')}>
                      <ListItemText
                        primary={
                          <Grid container>
                    ...
                    <ListItemButton selected={language === 'da'} onClick={(event) => handleListItemClick(event, 'da')}>
                      <ListItemText
                        primary={
                          <Grid container>
                            <Typography color="textPrimary">Dansk</Typography>
                            <Typography variant="caption" color="textSecondary" sx={{ ml: '8px' }}>
                              (Denmark)
                            </Typography>
                          </Grid>
                    ...
                    <ListItemButton selected={language === 'no'} onClick={(event) => handleListItemClick(event, 'no')}>
                      <ListItemText
                        primary={
                          <Grid container>
                            <Typography color="textPrimary">Norsk</Typography>
                            <Typography variant="caption" color="textSecondary" sx={{ ml: '8px' }}>
                              (Norway)
                            </Typography>
                          </Grid>
                    ...
                    <ListItemButton selected={language === 'sv'} onClick={(event) => handleListItemClick(event, 'sv')}>
                      <ListItemText
                        primary={
                          <Grid container>
