...
const Job = ({ open, close }) => {
  ...
  const [startDateVar, setStartDateVar] = useState(true);
  ...
  const validationSchema = yup.object({
    ...
    // longitude: yup.string().required(<FormattedMessage id="longitude-error" />),
      ...
      .test('is-greater', <FormattedMessage id="end-start" />, function (value, { parent }) {
        const { start } = parent;
    ...
    start: yup
      ...
      .test('is-greater', <FormattedMessage id="start-end" />, function (value) {
            ...
            <DialogContentText id="alert-dialog-slide-description" sx={{ marginTop: '15px' }}>
              <Grid container spacing={3}>
                ...
                <Grid item xs={12} sm={6}>
                  ...
                  {formik.errors.start && startDateVar === false && (
                    <FormHelperText>
                ...
                <Grid item xs={12} sm={6}>
                  ...
                  {formik.errors.end && endDateVar === false && (
                    <FormHelperText>
                      <Typography variant="caption" color="red">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        {formik.errors.end}
