...
import { updateCouponRequest } from 'store/slices/coupons';
...
const CourseUpdate = ({ open, close, item }) => {
  ...
  const validationSchema = yup.object({
    code: yup
      ...
      .max(50, 'Coupon code must be at most 250 characters'),
    description: yup
      .string()
      ...
      .max(250, 'Description must be at most 50 characters'),
  ...
  const initialValues = {
    ...
    value: item.value,
    expirDate: item?.expirDate ? parseISO(item.expirDate) : null
  };
