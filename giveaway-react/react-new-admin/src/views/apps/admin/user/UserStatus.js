...
import { statusChangeRequest } from 'store/slices/users';
            ...
            <DialogContentText id="alert-dialog-slide-description" sx={{ marginTop: '15px' }}>
              <Grid container spacing={3} alignItems="center" justifyContent="center">
                <Grid item xs={12} sm={6}>
                  <FormControl fullWidth error={formik.touched.isStatus && Boolean(formik.errors.isStatus)}>
                    <InputLabel id="status-label">Status</InputLabel>
                    <Select
                      id="demo-simple-select"
                      label="Status"
                      name="isStatus"
                      value={formik.values.isStatus || 'select'}
                    ...
                    {formik.touched.isStatus && formik.errors.isStatus && <FormHelperText>{formik.errors.isStatus}</FormHelperText>}
                  </FormControl>
                </Grid>
              </Grid>
            </DialogContentText>
